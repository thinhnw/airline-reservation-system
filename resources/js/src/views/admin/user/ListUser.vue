<template>
    <div class="col-md-12 p-0">
        ...
        <template #cell(control)="row">
            <i @click="row.toggleDetails"  :class="row.detailsShowing ? 'far fa-eye-slash' : 'far fa-eye'">

            </i>
            <i @click="editData(row.item.id)" class="far fa-edit btn-icon text-dark mx-2"></i>
